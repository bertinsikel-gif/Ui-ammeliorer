...
CREATE TABLE IF NOT EXISTS historiques_acces (
    id INT AUTO_INCREMENT PRIMARY KEY,
    etudiant_id INT,
    salle_id INT,
...
-- Admin par défaut
INSERT IGNORE INTO admins (username, password, email, nom, prenom) VALUES 
('admin', 'admin123', 'admin@ucbukavu.ac.cd', 'Administrateur', 'Système');

-- Étudiants de test
INSERT IGNORE INTO etudiants (matricule, nom, prenom, email, faculte, promotion) VALUES 
('05/23.09319', 'MUKAMBA', 'Jean', 'jean.mukamba@ucbukavu.ac.cd', 'Sciences Informatiques', '2023-2024'),
('05/23.09320', 'NABINTU', 'Marie', 'marie.nabintu@ucbukavu.ac.cd', 'Sciences Informatiques', '2023-2024'),
('02/22.01515', 'BAHATI', 'Pierre', 'pierre.bahati@ucbukavu.ac.cd', 'Sciences Économiques', '2022-2023'),
('01/24.00808', 'FURAHA', 'Grace', 'grace.furaha@ucbukavu.ac.cd', 'Médecine', '2024-2025');

-- Salles de test
INSERT IGNORE INTO salles (nom_salle, localisation, description, capacite) VALUES 
...
INSERT IGNORE INTO autorisations (etudiant_id, salle_id, niveau_acces, date_debut, date_fin) VALUES 
...
-- Historique de test
INSERT IGNORE INTO historiques_acces (etudiant_id, salle_id, matricule_utilise, type_acces, statut, date_entree) VALUES 
(1, 1, '05/23.09319', 'ENTREE', 'AUTORISE', '2024-01-15 09:30:00'),
(2, 1, '05/23.09320', 'ENTREE', 'AUTORISE', '2024-01-15 10:15:00'),
(3, 2, '02/22.01515', 'ENTREE', 'REFUSE', '2024-01-15 14:20:00');